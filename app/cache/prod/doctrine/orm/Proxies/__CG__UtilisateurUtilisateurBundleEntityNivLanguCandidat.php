 ...
 */
class NivLanguCandidat extends \Utilisateur\UtilisateurBundle\Entity\NivLanguCandidat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Utilisateur\\UtilisateurBundle\\Entity\\NivLanguCandidat' . "\0" . 'idNivLangu', '' . "\0" . 'Utilisateur\\UtilisateurBundle\\Entity\\NivLanguCandidat' . "\0" . 'idCandidat', '' . "\0" . 'Utilisateur\\UtilisateurBundle\\Entity\\NivLanguCandidat' . "\0" . 'idLangue', '' . "\0" . 'Utilisateur\\UtilisateurBundle\\Entity\\NivLanguCandidat' . "\0" . 'idNiveauLangue');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NivLanguCandidat $proxy) {
    ...
    public function getIdNivLangu()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdNivLangu();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdNivLangu', array());

        return parent::getIdNivLangu();
    }
    ...
    public function setIdLangue(\Utilisateur\UtilisateurBundle\Entity\Langues $idLangue = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdLangue', array($idLangue));
    ...
    public function getIdLangue()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdLangue', array());
    ...
    public function setIdNiveauLangue(\Utilisateur\UtilisateurBundle\Entity\NiveauLangue $idNiveauLangue = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdNiveauLangue', array($idNiveauLangue));

        return parent::setIdNiveauLangue($idNiveauLangue);
    }
