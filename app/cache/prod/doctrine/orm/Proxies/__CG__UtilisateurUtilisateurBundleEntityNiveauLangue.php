 ...
 */
class NiveauLangue extends \Utilisateur\UtilisateurBundle\Entity\NiveauLangue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Utilisateur\\UtilisateurBundle\\Entity\\NiveauLangue' . "\0" . 'idNiveauLangue', '' . "\0" . 'Utilisateur\\UtilisateurBundle\\Entity\\NiveauLangue' . "\0" . 'niveau');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NiveauLangue $proxy) {
    ...
    public function getIdNiveauLangue()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdNiveauLangue();
        }
